...
const getServiceInformation=(e)=>
{
    ...
    return <>
        ...
        <div className="grid grid-flow-col   grid-cols-12">
            ...
            <div className="col-span-8 rounded-[5px] p-5 bg-[#ebeee2b9] ">
                {/* software service */}
                <button value="softwareService"  onClick={getServiceInformation} className="bg-white hover:bg-[#bba9a9] w-[100%] text-left shadow-lg p-2 m-1 rounded-[3px]">1.Software Service</button><br />
                ...
                {/* Product */}
                <button value="product" onClick={getServiceInformation} className="bg-white hover:bg-[#bba9a9] w-[100%] text-left shadow-lg p-2 m-1 rounded-[3px]">2.Product</button><br />
                    <div id="product"  className=" hidden">
                        <img className="m-auto p-5 shadow-2xl" src={productImg}/>
                    </div>
                
                {/* Skill Trained */}
                <button value="skilltraining" onClick={getServiceInformation} className="bg-white hover:bg-[#bba9a9] w-[100%] text-left shadow-lg p-2 m-1 rounded-[3px]">3.Skill Training</button><br />
               ...
               {/* Talent Service */}
                <button value="talentservice" onClick={getServiceInformation} className="bg-white hover:bg-[#bba9a9] w-[100%] text-left shadow-lg p-2 m-1 rounded-[3px]">4.Talent Service</button><br />
...
Our combination of tech and touch is created for the modern agile organization focused on success. From product management professionals to digital transformation experts, our proven track record in finding the right technology staffing talent will take your organisation forward.
                ...
                {/* Career Service */}
                <button value="careerservice" onClick={getServiceInformation} className="bg-white hover:bg-[#bba9a9] w-[100%] text-left shadow-lg p-2 m-1 rounded-[3px]">5.Career Service</button><br />

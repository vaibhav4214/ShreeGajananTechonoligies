...
const Navbar = () => {
    ...
    return (<>
        ...
        <div className="lg:grid hidden bg-[white] lg:block  lg:grid-cols-12 py-1 border-solid border-2 ">
            ...
            <p className="col-span-3   p-2 pr-5  text-[#423b3b]"><span className="font-bold">Phone:</span> (+91) 11111111  |  <span className="font-bold ">Email:</span> <a className="hover:text-[grey]" href="mailto:Contact@shreegajanan.org" >Contact@shreegajanan.org</a></p>
